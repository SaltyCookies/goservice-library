...
func (r *TodoListPostgres) Create(userId int, list goservice.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]goservice.TodoList, error) {
	var lists []goservice.TodoList
...
func (r *TodoListPostgres) GetById(userId int, listId int) (goservice.TodoList, error) {
	var list goservice.TodoList
...
func (r *TodoListPostgres) Update(userId int, listId int, input goservice.UpdateListInput) error {
	...
	_, err := r.db.Exec(query, args[0], args[1], args[2], args[3])
	return err
}
